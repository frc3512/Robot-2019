...
Packet& Packet::operator>>(int16_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const int16_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
...
Packet& Packet::operator>>(uint16_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const uint16_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
...
Packet& Packet::operator>>(int32_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const int32_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
...
Packet& Packet::operator>>(uint32_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const uint32_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
...
Packet& Packet::operator>>(int64_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const int64_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
...
Packet& Packet::operator>>(uint64_t& data) {
    if (CheckSize(sizeof(data))) {
        data = *reinterpret_cast<const uint64_t*>(&m_packetData[m_readPos]);
        m_readPos += sizeof(data);
    }
